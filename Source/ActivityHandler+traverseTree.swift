...
extension ActivityHandler {
    ...
    public func handle(activity: NSUserActivity) -> Bool {
        return traverseTree(toHandle: activity, ignoring: nil) != nil
    }
     ...
     */
    @discardableResult
    public func traverseTree(toHandle activity: NSUserActivity, ignoring: ActivityHandler?) -> ActivityHandler? {
